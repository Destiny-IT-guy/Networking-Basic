# Ether channel
What is it? Etherchannel allow us to increase bandwith between 2 networking device by connecting multiple ports to eachother to act as one singular connection.
They are 2 different ethechannel protocol. First there is the cisco propritary protocol Port aggregation protocol **PAgp** and the link aggregation protocol **LACP**. I will show you how to use LACP. 

## benefits

| benefits                | explination |
|-------------------------|-------------|
|Increase bandwith | Allow you to combined many links to a more powrfull one|
